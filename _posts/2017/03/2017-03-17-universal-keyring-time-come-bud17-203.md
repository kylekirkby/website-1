...
{% include components/media.html media_url="https://www.youtube.com/embed/PvySBboUwPM" %}
...
{% include components/media.html media_url="//www.slideshare.net/slideshow/embed_code/key/s4eJMFzMpMaRIQ" %}
