...
<div class="col-md-4">
{% include components/media.html media_url="https://youtu.be/qPGTP_ZxDyY" %}
</div>
...
<div class="col-md-4">
{% include components/media.html media_url="https://www.youtube.com/watch?v=LwQ4IYuk1nk" %}
</div> <!-- End col-md-4-->
...
<div class="col-md-4">
{% include components/media.html media_url="https://www.youtube.com/watch?v=0jNAOzCn4Vc" %}
</div> <!-- End col-md-4-->
...
<div class="col-md-4">
{% include components/media.html media_url="https://youtu.be/BMmqtyqwmaM " %}
</div> <!-- End col-md-4-->
...
<div class="col-md-4">
{% include components/media.html media_url="https://www.youtube.com/watch?v=Ksegw928gUM" %}
</div> <!-- End col-md-4-->
...
<div class="col-md-4">
{% include components/media.html media_url="https://www.youtube.com/watch?v=loe0ZJVJGTg" %}
</div> <!-- End col-md-4-->
