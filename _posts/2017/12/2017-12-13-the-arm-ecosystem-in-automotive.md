...
{% include components/media.html media_url="https://youtu.be/XSk4oeIRRyU" %}
...
{% include components/media.html media_url="https://youtu.be/NEYO7q-x7b0" %}
...
{% include components/media.html media_url="https://youtu.be/DSFjAawIvmU" %}
